...
A highly interactive digital agency landing page built using **React**, **Tailwind CSS**, and **GSAP**. This project demonstrates visually stunning, animation-rich web experiences with modern frontend tools.

---

## ✨ Overview

Amora Prime is a modern digital agency website focused on **micro-animations**, **scroll-based interactions**, and **immersive visuals**. It features full-screen video sections, animated typography, interactive cards, a functional chatbot assistant, and smooth transitions that elevate user experience while maintaining performance and responsiveness.
